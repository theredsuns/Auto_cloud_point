...
# Encoder quantisation and Euler conversion regularly leave ~0.5 degree of
# residual error after a normal Cartesian settle.  One degree is still well
# below the capture-pose repeatability requirement, but avoids falsely
# stopping an automatic plan at 0.51–0.60 degree.
